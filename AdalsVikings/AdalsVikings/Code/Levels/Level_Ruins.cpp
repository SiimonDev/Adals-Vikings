...
void Level_Ruins::load()
{
	...
	mTileMap.addCollision(mNpcs["Aethelberth"]->getCollisionRect());
	mTileMap.setIndexOnMap(mNpcs["Aethelberth"]->getIndexRect(), mNpcs["Aethelberth"]->getIndex() - 1);
	mTileMap.addCollision(mNpcs["Cerdic"]->getCollisionRect());
	mTileMap.setIndexOnMap(mNpcs["Cerdic"]->getIndexRect(), mNpcs["Cerdic"]->getIndex() - 1);
	mTileMap.addCollision(mNpcs["Leofstan"]->getCollisionRect());
	mTileMap.setIndexOnMap(mNpcs["Leofstan"]->getIndexRect(), mNpcs["Leofstan"]->getIndex() - 1);
	mTileMap.addCollision(mNpcs["Osgar"]->getCollisionRect());
	mTileMap.setIndexOnMap(mNpcs["Osgar"]->getIndexRect(), mNpcs["Osgar"]->getIndex() - 1);
}
